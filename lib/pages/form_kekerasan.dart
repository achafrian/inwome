...
class Formkekerasan extends StatefulWidget {
  @override
  _Formkekerasan createState() => new _Formkekerasan();
}

class _Formkekerasan extends State<Formkekerasan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Form Konsultasi Kekerasan Dibawah Umur",
