...
class Formpelecehan extends StatefulWidget {
  @override
  _Formpelecehan createState() => new _Formpelecehan();
}

class _Formpelecehan extends State<Formpelecehan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Form Konsultasi Pelecehan Seksual",
